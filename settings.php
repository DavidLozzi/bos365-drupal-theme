 ...
 * @endcode
 */
$settings['hash_salt'] = 'Ae4UdftLl5UbhhU9mj8sCqLA-Zt-CIcgvBxkhK8uW3CH741anv_YltLbsP2-GI2LOCZrPXZRCQ';
 ...
 */
 $settings['trusted_host_patterns'] = [
   '^bostono365usergroup\.com$',
   '^.+\.bostono365usergroup\.com$',
   '^bos365\.eastus2\.cloudapp\.azure\.com$',
   '^localhost$'
 ];
 /*
 * @endcode
...
$databases['default']['default'] = array (
  'database' => 'bos365mysql',
  'username' => 'bos365adm@bos365mysql',
  'password' => 'G0 P@tri0ts',
  'prefix' => '',
  'host' => 'bos365mysql.mysql.database.azure.com',
  'port' => '3306',
  'namespace' => 'Drupal\\Core\\Database\\Driver\\mysql',
  'driver' => 'mysql',
);
$settings['install_profile'] = 'standard';
$config_directories['sync'] = 'sites/default/files/config_j4nMI2fXe6W5Ay7ONv092FsMLuv_vTHbXxi3ZsgmnKiK0sps-QC4wSsCtygY875BIX8Fa_TLkA/sync';
